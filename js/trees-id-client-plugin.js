						...
						if (currentTree.length > 0) {
							currentTree.forEach(function(value, index){
								if (lastTree.indexOf(value) === -1) {
									...
									//console.log(polygonData[value[2]].id_tree+'|'+value[0]+'|'+value[1]);

									var currentTreePage = treePage.replace('[lot]',polygonData[value[2]].tree_lot_id).replace('[offset]',polygonData[value[2]].tree_offset);
									var treeDetail = '<a href="'+ currentTreePage +'"><img src="' + polygonData[value[2]].img_tree +'" width="200"></a>';
