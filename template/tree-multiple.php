...
<div id="" class="tid-tree-detail tid-shortcode">
	...
	<?php if (isset($tree_id_str )): ?>
		...
		<div id="trees-id-map" class="trees-id-map" data-map-type="archive-tree" data-nohp="<?php echo $nohp ?>" data-tree-page="http://portal.trees.id/tree-view-new/[lot]/[offset]" style="display:block;"></div>
		<br>
